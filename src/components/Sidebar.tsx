        ...
        <div className="p-6 space-y-8 flex-1 flex flex-col">
          ...
          <div className="hidden lg:flex items-center gap-3.5">
            ...
            <div className="flex flex-col">
              <h1 className="text-sm font-extrabold text-slate-900 tracking-wide leading-tight">
                CCGS <span className="font-medium text-slate-500">Alumni Hub</span>
              </h1>
              <p className="text-[8.5px] text-slate-400 font-bold uppercase tracking-widest mt-0.5 leading-none">
                Coordinator Panel
              </p>
            </div>
          </div>
